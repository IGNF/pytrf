...
class sinex:
    ...
    def helmert_partials(snx, helmerts, par, units=None, select_periods='all'):
        ...
        if (units is None):
            ...
            if par!='PERIOD':
                ...
                A *= np.tile(unit_array, 2*nper) #2: cos & sin parameters
        else:
            A /= ae
    ...
    def add_mc(snx, helmerts, par, sigma=1e-5, datum=None, crf_datum=None, thr=None, proj=True, periods=[], quiet=True, out=sys.stdout):
    ...
    def compare(snx, ref, helmerts, weighting='full', apply_vf=True, norm_res='approx', quiet=False, out=sys.stdout):
        ...
        # Else,
            ...
            if (nper > 0): #at least 1 period
                startid = 14 #previously 7 sta + 7 vel #WARNING : with 'A' -> 17 ?
